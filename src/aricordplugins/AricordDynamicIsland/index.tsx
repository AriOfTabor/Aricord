...
const cl = classNameFactory("vc-aricord-dynamic-island-");
const NOTIFICATION_DURATION = 5000;
const RUNTIME_KEY = Symbol.for("AricordDynamicIsland.runtime");
    ...
    return (
        <div className={cl("root", `color-${islandColor}`, {
            ...
            <Clickable
                ...
                aria-label="Aricord Dynamic Island"
            ...
            >
                ...
                <div key={notification?.id ?? primary ?? "idle"} className={cl("summary-copy")}>
                    <strong>{notification?.title ?? (primaryStream ? "You are sharing your screen" : primaryTrack?.name ?? (primaryChannelId ? "Discord call" : "Aricord Dynamic Island"))}</strong>
