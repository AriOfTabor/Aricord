...
By now, you should have cloned the Aricord repository and pointed your terminal to the Aricord folder. If you have done this, do the following:

1. Change your current directory on your terminal to the `aricordplugins` folder, e.g. `cd src/aricordplugins`.
2. Run the following command to download the plugin into the `aricordplugins` folder.
...
You will have to direct your terminal to the plugin folder (`cd src/aricordplugins/BoosterCount`) and run:
