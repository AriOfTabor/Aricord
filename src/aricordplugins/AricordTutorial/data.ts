...
export const TUTORIAL_SEEN_KEY = "AricordTutorial_seen_v1";
export const TUTORIAL_LANGUAGE_KEY = "AricordTutorial_language";
...
export const UI_COPY = {
    en: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "You can reopen this tutorial from the AricordTutorial settings.",
    ...
    it: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "Puoi riaprire questo tutorial dalle impostazioni di AricordTutorial.",
...
export const TUTORIAL_STEPS: TutorialStep[] = [
    {
        title: {
            en: "Welcome to Aricord",
            it: "Benvenuta in Aricord"
        },
        route: {
            en: "First startup",
            it: "Primo avvio"
    ...
    },
    {
        title: {
            en: "Aricord settings",
            it: "Impostazioni Aricord"
        },
        route: {
            en: "Settings > Aricord Settings",
            it: "Settings > Aricord Settings"
        },
        body: {
            en: "The Aricord section is the control room for the client. Start there when you want to change behavior or find a tool.",
            it: "La sezione Aricord è la sala comandi del client. Parti da lì quando vuoi cambiare comportamento o trovare uno strumento."
        },
        bullets: {
            en: [
                "Aricord contains general client settings.",
                "Plugins lists Vencord, Equicord, Aricord, and user plugins.",
                "Themes, Updater, Changelog, and Backup each have their own page."
            ],
            it: [
                "Aricord contiene le impostazioni generali del client.",
                "Plugins mostra i plugin Vencord, Equicord, Aricord e quelli dell'utente.",
    ...
    },
    {
        ...
        route: {
            en: "Settings > Aricord Settings > Plugins",
            it: "Settings > Aricord Settings > Plugins"
        },
        body: {
    ...
    },
    {
        ...
        body: {
            en: "If Aricord lags, freezes, or starts using too much memory, open Client Diagnostics before disabling random plugins.",
            it: "Se Aricord lagga, si blocca, o usa troppa memoria, apri Client Diagnostics prima di disattivare plugin a caso."
        },
        bullets: {
            en: [
        ...
        panel: "aricord_client_diagnostics_panel",
        actionLabel: {
            en: "Open Diagnostics",
            it: "Apri Diagnostics"
        }
    },
    {
        ...
        route: {
            en: "Settings > Aricord Settings > Themes",
            it: "Settings > Aricord Settings > Themes"
        },
        body: {
    ...
    },
    {
        ...
        panel: "aricord_stereo_installer_panel",
        actionLabel: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > Aricord Settings > Updater",
            it: "Settings > Aricord Settings > Updater"
        },
        body: {
            en: "Updater checks for Aricord updates. Use it when a patch breaks, the client crashes, or you want the newest fixes.",
            it: "Updater controlla gli aggiornamenti di Aricord. Usalo quando una patch si rompe, il client crasha, o vuoi gli ultimi fix."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        route: {
            en: "Settings > Aricord Settings > Changelog",
            it: "Settings > Aricord Settings > Changelog"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > Aricord Settings > Backup & Restore",
            it: "Settings > Aricord Settings > Backup & Restore"
        },
        body: {
