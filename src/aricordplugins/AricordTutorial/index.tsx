...
export default definePlugin({
    name: "AricordTutorial",
    description: "Shows a first-run guided tutorial for Aricord features.",
    ...
    get toolboxActions(): Record<string, () => void> {
        ...
        return {
            "Open Aricord tutorial": openTutorial,
            "Show Aricord tutorial next startup": resetTutorialSeen
        };
    },
