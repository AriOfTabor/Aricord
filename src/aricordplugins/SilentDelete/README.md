...
```
3. Navigate to the `src/aricordplugins` folder in the cloned Aricord repository.

3. Download `silentDelete.tsx` from the repository and move it to the `aricordplugins` folder.
