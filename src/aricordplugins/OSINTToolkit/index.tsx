...
const SETTINGS_ENTRY_KEY = "aricord_osint_fanboy_club";
...
function OSINTToolkitSettingsAbout() {
    return (
        <Notice.Warning className={Margins.bottom8}>
            ...
            <p>Queries can send identifiers, search terms, images, your IP address, and request metadata to independent services including CordCat, Breach.vip, and GeoSeeer. Review each provider&apos;s terms and privacy notice before use. Aricord does not control their data, retention, accuracy, or legal compliance. Nothing in this notice excludes liability that cannot be excluded under applicable law.</p>
