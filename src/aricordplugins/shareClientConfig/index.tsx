...
const FILE_NAME = "aricord-config.json";
const FORMAT = "aricord-shared-config";
...
async function applySharedConfig(attachment: MessageAttachment): Promise<void> {
    try {
        ...
        showToast("Configuration applied. Restart Aricord to finish applying the changes.", Toasts.Type.SUCCESS);
    } catch (error) {
...
export default definePlugin({
    ...
    description: "Share your Aricord configuration in chat without API keys or other sensitive values.",
    ...
    settingsAboutComponent() {
        return (
            <>
                ...
                <Paragraph>
                    Share your Aricord and plugin settings through a chat attachment.
                ...
                <Paragraph>
                    ...
                    {" "}<strong>Apply Aricord configuration</strong> in the message action bar.
                    Confirm with <strong>Apply</strong>, wait for the success message, then restart Aricord.
                ...
                <Paragraph>
                    ...
                    You can save a backup from the Aricord settings before applying a configuration.
                </Paragraph>
    ...
    commands: [{
        name: "share-config",
        description: "Prepare your Aricord configuration for sharing without sensitive data.",
    ...
    messagePopoverButton: {
        ...
        render(message) {
            ...
            return {
                label: "Apply Aricord configuration",
                icon: ConfigIcon,
                message,
