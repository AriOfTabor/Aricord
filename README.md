...
- **150+ bundled plugins** — from Vencord, Equicord, Aricord and Aricord, all toggleable in settings
...
| `src/aricordplugins` | Aricord + Aricord plugins |
...
- **[ImHisako](https://github.com/ImHisako)** — Aricord and its plugin layer
